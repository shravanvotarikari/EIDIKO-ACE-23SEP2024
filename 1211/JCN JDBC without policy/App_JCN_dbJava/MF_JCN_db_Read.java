...
public class MF_JCN_db_Read extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement employees = inMessage.getRootElement().getLastChild().getFirstChild().getFirstChild();
			String str = employees.getName();
			MbElement mb_employee_id = employees.getFirstChild();
			 ...
			 String query = "SELECT employee_id, first_name, last_name, department, salary FROM employees";
