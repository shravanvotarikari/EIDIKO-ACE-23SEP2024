...
public class MF_CSVtoXML_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			MbElement employees = xmlnsc.createElementAsLastChild(MbElement.TYPE_NAME,"employees",null);

			MbElement DFDL = inMessage.getRootElement().getLastChild();
			MbElement schemaName = DFDL.getLastChild();
			MbElement Employee = schemaName.getFirstChild().getNextSibling();
//			schemaName.firstchild is csv header and nextSibling is actual employee data
