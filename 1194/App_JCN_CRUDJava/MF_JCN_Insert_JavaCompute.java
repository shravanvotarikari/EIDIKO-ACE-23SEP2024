...
public class MF_JCN_Insert_JavaCompute extends MbJavaComputeNode {
...
//			Extracting input data
			...
			MbElement Age = inputroot.getFirstElementByPath("XMLNSC/Root/age");
			String id = Id.getValueAsString();
			String name = Name.getValueAsString();
			String age = Age.getValueAsString();
...
//			Setting OutputRoot
			...
			if(count > 0) {
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME, "Result", "Data inserted successfully");
			}
			else {
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME, "Result", "Data not inserted successfully");
			}
