...
public class MF_ODBC_Select_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			if(sqlCode != 0)
			{
				...
				xmlnsc.createElementAsLastChild(MbElement.TYPE_NAME, "Result", "Failed to Perform Database Select Operation");
			}
