...
public class MF_delete_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			ps.setString(1, Eid.getValueAsString());
...
int count = ps.executeUpdate();
			...
			if(count > 0) {
				...
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "Result", "DATA DELETED SUCCESSFULLY");
			}
			else {
				MbElement outputroot  = outMessage.getRootElement().createElementAsLastChild(MbXMLNSC.PARSER_NAME);
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "Result", "DATA NOT DELETED SUCCESSFULLY");
			}
