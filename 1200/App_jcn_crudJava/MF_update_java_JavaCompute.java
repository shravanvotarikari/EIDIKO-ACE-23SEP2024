...
public class MF_update_java_JavaCompute extends MbJavaComputeNode {
	...
	public void evaluate(MbMessageAssembly inAssembly) throws MbException {
		...
		try {
			...
			String query = "UPDATE INFORMATION SET ENAME = ? WHERE ID = ?";
...
int count = ps.executeUpdate();
			...
			if(count > 0) {
				...
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "Result", "Data UPDATED successfully");
			}
			else {
				MbElement outputroot  = outMessage.getRootElement().createElementAsLastChild(MbXMLNSC.PARSER_NAME);
				outputroot.createElementAsLastChild(MbElement.TYPE_NAME_VALUE, "Result", "Data not UPDATED successfully");
			}
